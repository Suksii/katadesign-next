...
const CustomButton = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`${classNameBg} px-8 py-3 w-full md:w-32  text-white shadow-lg active:scale-95 transition-all duration-300 ease-in-out font-semibold text-sm uppercase tracking-wider cursor-pointer border-0 focus:outline-none relative rounded overflow-hidden group`}
    >
